...
ax.set_ylabel("QPS", fontsize=15)
plt.title(f'QPS (L: 50)', fontsize=17, fontweight='bold', pad=5)
...
# 保存为高质量科研图像
plt.savefig(f'/mnt/hgfs/DataSet/experiment_results/QPS-L50.svg', dpi=150, bbox_inches='tight')
plt.show()
