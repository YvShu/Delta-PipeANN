...
ax.set_ylabel("Mean Lat", fontsize=15)
plt.title(f'Mean Lat (L: 50)', fontsize=17, fontweight='bold', pad=5)
...
# 保存为高质量科研图像
plt.savefig(f'/mnt/hgfs/DataSet/experiment_results/Lat-L50.svg', dpi=150, bbox_inches='tight')
plt.show()
